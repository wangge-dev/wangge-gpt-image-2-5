...
Explore 121 base prompts (82 adapted cards, 28 originals and 11 prompts developed from documented 2.5 examples), plus 117 complete variations. The collection includes 22 general templates, 44 ecommerce scenarios and 35 curated creative prompts. Ecommerce templates offer 86 variations, from clean product shots to seasonal campaigns.
...
Ecommerce cards EC01–EC44 include filled, copy-ready Chinese examples alongside reusable variable templates.
...
Ecommerce cards EC01–EC44 include explicit reference-image requirements and fully filled Chinese examples alongside their variable templates.
