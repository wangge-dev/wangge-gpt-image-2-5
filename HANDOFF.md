...
- 403条基础提示词：383张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T278–T280补腕表表带穿扣、宠物胸背带跨视图映射和充电线双端连续链；阶段P推进到403/420。
...
- `python scripts/check_links.py`：2547个本地Markdown链接通过。
- 383个JSON卡，无重复ID，生成卡齐全。
- 总条目403、变体132；八套任务包48步、48个文本块、无双花括号变量。
