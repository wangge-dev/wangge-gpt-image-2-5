...
- 200条基础提示词：180张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T74–T77补卡扣锁止窗口、起绒面料毛向、可拆内胆结合点和卷轴海报边界。
...
- 总条目200、变体132；八套任务包48步、48个文本块、无双花括号变量。
