...
- 409条基础提示词：389张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T284–T286补手机壳多面对位、拉杆箱左右仓映射和一体购物袋材料守恒；阶段P推进到409/420。
...
- `python scripts/check_links.py`：2577个本地Markdown链接通过。
- 389个JSON卡，无重复ID，生成卡齐全。
- 总条目409、变体132；八套任务包48步、48个文本块、无双花括号变量。
