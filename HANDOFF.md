...
- 340条基础提示词：320张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T214–T217补透明标签白墨衬底、穿孔金属印字、纸套镂空字与提花弹力带双状态。
...
- `python scripts/check_links.py`：2232个本地Markdown链接通过。
- 320个JSON卡，无重复ID，生成卡齐全。
- 总条目340、变体132；八套任务包48步、48个文本块、无双花括号变量。
