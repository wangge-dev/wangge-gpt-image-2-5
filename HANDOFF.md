...
- 220条基础提示词：200张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T94–T97补独立创可贴袋清点、修正带带路、物流面单母子联和活页索引分页。
...
- 总条目220、变体132；八套任务包48步、48个文本块、无双花括号变量。
