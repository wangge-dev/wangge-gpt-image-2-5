...
- 346条基础提示词：326张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T221–T223补旋转套筒窗口、双面翻片和可拆面板复装状态。
...
- `python scripts/check_links.py`：2262个本地Markdown链接通过。
