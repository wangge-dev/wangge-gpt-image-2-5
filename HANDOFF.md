...
- 412条基础提示词：392张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T287–T289补被套四角绑带、床笠逐角套合和打孔窗帘孔序穿杆；阶段P推进到412/420。
...
- `python scripts/check_links.py`：2592个本地Markdown链接通过。
- 392个JSON卡，无重复ID，生成卡齐全。
- 总条目412、变体132；八套任务包48步、48个文本块、无双花括号变量。
