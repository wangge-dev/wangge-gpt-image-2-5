...
- 117条基础提示词：97张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 117个完整变体。
- 40套电商场景；EC01–EC40有填写完成的直接示例；另有35条精选创意，其中G33–G35补收藏玩具、食品品牌与腕表技术视觉。
...
- 总条目117、变体117；八套任务包48步、48个文本块、无双花括号变量。
