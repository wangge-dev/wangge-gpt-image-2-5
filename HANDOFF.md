...
- 420条基础提示词：400张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T294–T297补保鲜盒多层封合、婴儿车五点带、骑行头盔分叉带和汽车折叠收纳箱；阶段P达到420/420，后续进入阶段Q 420→440。
...
- `python scripts/check_links.py`：2632个本地Markdown链接通过。
- 400个JSON卡，无重复ID，生成卡齐全。
- 总条目420、变体132；八套任务包48步、48个文本块、无双花括号变量。
