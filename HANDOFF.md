...
- 277条基础提示词：257张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T152–T154补按压旋转瓶盖、封膜与垫片载体分离、圆柱环绕标签接缝。
...
- `python scripts/check_links.py`：1917个本地Markdown链接通过。
- 257个JSON卡，无重复ID，生成卡齐全。
- 总条目277、变体132；八套任务包48步、48个文本块、无双花括号变量。
