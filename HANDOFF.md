...
- 188条基础提示词：168张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T62–T65补防呆接口到位、冷冻食品时点、卷材回卷和吊旗吊点映射。
...
- 总条目188、变体132；八套任务包48步、48个文本块、无双花括号变量。
