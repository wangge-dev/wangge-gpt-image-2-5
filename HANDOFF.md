...
- 227条基础提示词：207张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T103–T104补折叠周转箱铰接状态和仓位码跨三载体映射。
...
- 总条目227、变体132；八套任务包48步、48个文本块、无双花括号变量。
