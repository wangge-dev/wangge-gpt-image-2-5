...
- 440条基础提示词：420张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T314–T317补相机快装链、行李箱指定轮、吸管杯连续管路和自行车灯两级连接；阶段Q达到440/440，后续进入阶段R 440→460。
...
- `python scripts/check_links.py`：2732个本地Markdown链接通过。
- 420个JSON卡，无重复ID，生成卡齐全。
- 总条目440、变体132；八套任务包48步、48个文本块、无双花括号变量。
