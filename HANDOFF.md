...
- 383条基础提示词：363张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T258–T260补剪刀双刃共轴、游标卡尺双标尺滑移与圆规针笔双腿；阶段O已启动。
...
- `python scripts/check_links.py`：2447个本地Markdown链接通过。
- 363个JSON卡，无重复ID，生成卡齐全。
- 总条目383、变体132；八套任务包48步、48个文本块、无双花括号变量。
