...
- 156条基础提示词：136张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有51条精选创意，其中G49–G51补遇水显纹伞面、击凸包装双光型与磁吸配件三阶段对位。
...
- 总条目156、变体132；八套任务包48步、48个文本块、无双花括号变量。
