...
- 147条基础提示词：127张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有42条精选创意，其中G40–G42补镜片内外双场景、货架陈列对照与真实鞋底纹路运动轨迹。
...
- 总条目147、变体132；八套任务包48步、48个文本块、无双花括号变量。
