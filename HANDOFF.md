...
- 369条基础提示词：349张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T244–T246补四合扣四层、卷口逐圈折卷与硅胶杯逐环套叠；阶段N推进至369/380。
...
- `python scripts/check_links.py`：2347个本地Markdown链接通过。
