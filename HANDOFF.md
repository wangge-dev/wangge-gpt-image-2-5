...
- 375条基础提示词：355张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T250–T252补雨伞滑套多连杆、钢丝扣罐盖垫层级与拉珠卷帘闭环驱动；阶段N推进至375/380。
...
- `python scripts/check_links.py`：2407个本地Markdown链接通过。
- 355个JSON卡，无重复ID，生成卡齐全。
- 总条目375、变体132；八套任务包48步、48个文本块、无双花括号变量。
