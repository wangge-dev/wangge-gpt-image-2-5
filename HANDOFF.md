...
- 216条基础提示词：196张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T90–T93补退货袋双封条、气柱袋腔体、除尘滚筒层号和纸袋提绳拓扑。
...
- 总条目216、变体132；八套任务包48步、48个文本块、无双花括号变量。
