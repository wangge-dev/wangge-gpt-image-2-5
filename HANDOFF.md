...
- 166条基础提示词：146张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T41–T43补审定文案映射、素材版本状态与单差异遮罩返工。
...
- 总条目166、变体132；八套任务包48步、48个文本块、无双花括号变量。
