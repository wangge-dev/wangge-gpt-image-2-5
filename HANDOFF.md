...
- 169条基础提示词：149张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T44–T46补系列人工锁定核对、失败轮次回退证据与发布资产清单。
...
- 总条目169、变体132；八套任务包48步、48个文本块、无双花括号变量。
