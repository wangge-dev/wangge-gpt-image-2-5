...
- 263条基础提示词：243张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T138–T140补连接器防尘帽停放、五金分格盘逐格映射与纸箱提手翻片材料守恒。
...
- `python scripts/check_links.py`：1847个本地Markdown链接通过。
- 243个JSON卡，无重复ID，生成卡齐全。
- 总条目263、变体132；八套任务包48步、48个文本块、无双花括号变量。
