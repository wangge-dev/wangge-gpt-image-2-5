...
- 496条基础提示词：476张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T370–T373补项链、腕表折叠扣、双臂台灯与可调哑铃的真实拓扑；阶段T推进到496/500。
...
- `python scripts/check_links.py`：3012个本地Markdown链接通过。
- 476个JSON卡，无重复ID，生成卡齐全。
- 总条目496、变体132；八套任务包48步、48个文本块、无双花括号变量。
