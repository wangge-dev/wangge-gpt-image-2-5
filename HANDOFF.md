...
- 500条基础提示词：480张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T374–T377补窗帘挂点、起泡器层序、头戴耳机复合自由度与折叠椅框架；阶段T已完成500/500。
...
- `python scripts/check_links.py`：3032个本地Markdown链接通过。
- 480个JSON卡，无重复ID，生成卡齐全。
- 总条目500、变体132；八套任务包48步、48个文本块、无双花括号变量。
