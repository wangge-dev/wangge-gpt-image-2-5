...
- 520条基础提示词：500张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T394–T397补饮水管路由、左右扶手、集尘袋入轨闭盖与标签带随盒；阶段U已完成520/520。
...
- `python scripts/check_links.py`：3132个本地Markdown链接通过。
- 500个JSON卡，无重复ID，生成卡齐全。
- 总条目520、变体132；八套任务包48步、48个文本块、无双花括号变量。
