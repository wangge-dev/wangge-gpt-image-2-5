...
- 396条基础提示词：376张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T270–T273补指甲钳复合压杆、按动笔同轴伸缩、手摇打蛋器外露齿轮和胶带座连续材料路径；阶段O推进到396/400。
...
- `python scripts/check_links.py`：2512个本地Markdown链接通过。
- 376个JSON卡，无重复ID，生成卡齐全。
- 总条目396、变体132；八套任务包48步、48个文本块、无双花括号变量。
