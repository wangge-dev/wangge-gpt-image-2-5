...
- 255条基础提示词：235张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T130–T132补替换内芯键位窗口、挖勺卡槽空位、双腔泵瓶双通道映射。
...
- `python scripts/check_links.py`：1807个本地Markdown链接通过。
- 235个JSON卡，无重复ID，生成卡齐全。
- 总条目255、变体132；八套任务包48步、48个文本块、无双花括号变量。
