...
- 295条基础提示词：275张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T170–T172补牵引杆状态、透明反印标签改字和烫金标题工艺继承。
...
- `python scripts/check_links.py`：2007个本地Markdown链接通过。
- 275个JSON卡，无重复ID，生成卡齐全。
- 总条目295、变体132；八套任务包48步、48个文本块、无双花括号变量。
