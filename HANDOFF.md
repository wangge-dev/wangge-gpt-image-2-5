...
- 380条基础提示词：360张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T253–T257补百叶帘、光圈、活动扳手、三脚架与环形活页夹；阶段N达到380/380。
...
- `python scripts/check_links.py`：2432个本地Markdown链接通过。
- 360个JSON卡，无重复ID，生成卡齐全。
- 总条目380、变体132；八套任务包48步、48个文本块、无双花括号变量。
