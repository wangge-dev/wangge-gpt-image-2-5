...
- 177条基础提示词：157张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T51–T54补笔芯装配、玩具分袋、五金孔位与帐篷风绳四类结构追踪。
...
- 总条目177、变体132；八套任务包48步、48个文本块、无双花括号变量。
