...
- 163条基础提示词：143张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T38–T40补生产链入口的素材职责、人工差异标注与渠道裁切预演。
...
- 总条目163、变体132；八套任务包48步、48个文本块、无双花括号变量。
