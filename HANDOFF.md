...
- 208条基础提示词：188张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T82–T85补订书机钉条、托盘打包带、扫地机边刷和骑马钉册页。
...
- 总条目208、变体132；八套任务包48步、48个文本块、无双花括号变量。
