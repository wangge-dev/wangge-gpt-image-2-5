...
- 360条基础提示词：340张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T233–T237补球头座圈、过中心搭扣、钥匙孔挂槽、两件式推铆钉和转舌锁状态；阶段M完成。
...
- `python scripts/check_links.py`：2332个本地Markdown链接通过。
