...
- 246条基础提示词：226张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T121–T123补软管尾封批号、滴管料柱与液面、补充袋角嘴焊接和盖环归属。
...
- `python scripts/check_links.py`：1762个本地Markdown链接通过。
- 226个JSON卡，无重复ID，生成卡齐全。
- 总条目246、变体132；八套任务包48步、48个文本块、无双花括号变量。
