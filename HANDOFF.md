...
- 372条基础提示词：352张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T247–T249补翻杆吸盘、登山扣门片与折扇多骨共轴；阶段N推进至372/380。
...
- `python scripts/check_links.py`：2392个本地Markdown链接通过。
- 352个JSON卡，无重复ID，生成卡齐全。
- 总条目372、变体132；八套任务包48步、48个文本块、无双花括号变量。
