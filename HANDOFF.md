...
- 512条基础提示词：492张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T386–T389补软管绕鼓、冰箱搁架卡耳、钥匙双圈旋入与隐私行李牌显隐；阶段U推进到512/520。
...
- `python scripts/check_links.py`：3092个本地Markdown链接通过。
- 492个JSON卡，无重复ID，生成卡齐全。
- 总条目512、变体132；八套任务包48步、48个文本块、无双花括号变量。
