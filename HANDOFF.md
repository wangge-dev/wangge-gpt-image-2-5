...
- 432条基础提示词：412张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T307–T309补吹风机前后端附件、电动牙刷刷头与底座、电钻夹头与电池滑轨；阶段Q推进到432/440。
...
- `python scripts/check_links.py`：2692个本地Markdown链接通过。
- 412个JSON卡，无重复ID，生成卡齐全。
- 总条目432、变体132；八套任务包48步、48个文本块、无双花括号变量。
