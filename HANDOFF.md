...
- 271条基础提示词：251张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T146–T148补书型礼盒双限位带、风琴侧褶层序和可揭回贴标签复位。
...
- `python scripts/check_links.py`：1887个本地Markdown链接通过。
- 251个JSON卡，无重复ID，生成卡齐全。
- 总条目271、变体132；八套任务包48步、48个文本块、无双花括号变量。
