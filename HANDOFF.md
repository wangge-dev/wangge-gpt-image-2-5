...
- 429条基础提示词：409张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T304–T306补电饭煲三套附件归属、电动打蛋器双杆键位和挂烫机分路附件；阶段Q推进到429/440。
...
- `python scripts/check_links.py`：2677个本地Markdown链接通过。
- 409个JSON卡，无重复ID，生成卡齐全。
- 总条目429、变体132；八套任务包48步、48个文本块、无双花括号变量。
