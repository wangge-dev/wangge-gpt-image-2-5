...
- 153条基础提示词：133张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有48条精选创意，其中G46–G48补镭射包装角度色移、夜光表盘明暗序列与可刮涂层三状态。
...
- 总条目153、变体132；八套任务包48步、48个文本块、无双花括号变量。
