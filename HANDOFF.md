...
- 249条基础提示词：229张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T124–T126补面霜罐多层盖、滚珠瓶座圈遮挡、旋出膏体露出高度。
...
- `python scripts/check_links.py`：1777个本地Markdown链接通过。
- 229个JSON卡，无重复ID，生成卡齐全。
- 总条目249、变体132；八套任务包48步、48个文本块、无双花括号变量。
