...
- 416条基础提示词：396张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T290–T293补真空袋封口阀盖、沙发坐垫套、信封枕套和磁吸纱门；阶段P推进到416/420。
...
- `python scripts/check_links.py`：2612个本地Markdown链接通过。
- 396个JSON卡，无重复ID，生成卡齐全。
- 总条目416、变体132；八套任务包48步、48个文本块、无双花括号变量。
