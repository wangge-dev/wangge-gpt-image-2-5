...
- 237条基础提示词：217张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T112–T114补打孔器隐藏冲头孔位、长尾夹双臂转轴、旋钮刻度环与固定指针对照。
...
- `python scripts/check_links.py`：1717个本地Markdown链接通过。
- 217个JSON卡，无重复ID，生成卡齐全。
- 总条目237、变体132；八套任务包48步、48个文本块、无双花括号变量。
