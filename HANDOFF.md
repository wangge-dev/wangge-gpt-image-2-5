...
- 386条基础提示词：366张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T261–T263补大力钳四连杆锁定、棘轮扳手外部换向状态与推钮美工刀分节刀片伸缩；阶段O推进到386/400。
...
- `python scripts/check_links.py`：2462个本地Markdown链接通过。
- 366个JSON卡，无重复ID，生成卡齐全。
- 总条目386、变体132；八套任务包48步、48个文本块、无双花括号变量。
