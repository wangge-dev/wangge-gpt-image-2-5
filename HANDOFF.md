...
- 243条基础提示词：223张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T118–T120补透明泵瓶吸管路径、纸盒易撕条材料守恒、真空瓶活塞与料体边界。
...
- `python scripts/check_links.py`：1747个本地Markdown链接通过。
- 223个JSON卡，无重复ID，生成卡齐全。
- 总条目243、变体132；八套任务包48步、48个文本块、无双花括号变量。
