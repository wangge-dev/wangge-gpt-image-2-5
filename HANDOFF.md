...
- 289条基础提示词：269张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T164–T166补脚轮运动层、安全链端点和立体包装三面中文改字。
...
- `python scripts/check_links.py`：1977个本地Markdown链接通过。
- 269个JSON卡，无重复ID，生成卡齐全。
- 总条目289、变体132；八套任务包48步、48个文本块、无双花括号变量。
