...
- 173条基础提示词：153张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T47–T50补透明容器、镜面金属、宠物扣件与车载视野四类证据约束。
...
- 总条目173、变体132；八套任务包48步、48个文本块、无双花括号变量。
