...
- 423条基础提示词：403张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T298–T300补空气炸锅抽屉层级、吸尘器尘杯滤层和搅拌杯底部旋合；阶段Q推进到423/440。
...
- `python scripts/check_links.py`：2647个本地Markdown链接通过。
- 403个JSON卡，无重复ID，生成卡齐全。
- 总条目423、变体132；八套任务包48步、48个文本块、无双花括号变量。
