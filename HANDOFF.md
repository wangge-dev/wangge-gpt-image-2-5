...
- 150条基础提示词：130张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有45条精选创意，其中G43–G45补双视角光栅、反光服饰闪光对照与防拆封签三状态。
...
- 总条目150、变体132；八套任务包48步、48个文本块、无双花括号变量。
