...
- 192条基础提示词：172张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T66–T69补螺纹起扣、贴标缺陷、食品分层装配和实体折页映射。
...
- 总条目192、变体132；八套任务包48步、48个文本块、无双花括号变量。
