...
- 196条基础提示词：176张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T70–T73补泵头回弹、保护膜边界、冲泡粉体时点和吸塑泡壳映射。
...
- 总条目196、变体132；八套任务包48步、48个文本块、无双花括号变量。
