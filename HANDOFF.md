...
- 252条基础提示词：232张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T127–T129补翻盖塞柱对孔、气垫盒逐层清点、连袋小包撕线与批号载体。
...
- `python scripts/check_links.py`：1792个本地Markdown链接通过。
- 232个JSON卡，无重复ID，生成卡齐全。
- 总条目252、变体132；八套任务包48步、48个文本块、无双花括号变量。
