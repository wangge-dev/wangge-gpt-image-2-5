...
- 224条基础提示词：204张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T98–T101补口罩面向与焊点、托盘缠绕膜层级、束线带搭接路径和三联单压痕归属。
...
- 总条目224、变体132；八套任务包48步、48个文本块、无双花括号变量。
