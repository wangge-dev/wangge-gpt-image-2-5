...
- 280条基础提示词：260张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T155–T157补纸盒粘合接缝、挂孔加强片双层对位和展示箱易撕面板材料守恒。
...
- `python scripts/check_links.py`：1932个本地Markdown链接通过。
- 260个JSON卡，无重复ID，生成卡齐全。
- 总条目280、变体132；八套任务包48步、48个文本块、无双花括号变量。
