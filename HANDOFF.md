...
- 389条基础提示词：369张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T264–T266补切管器径向进给、压胶枪推杆状态链与剥线钳编号半孔配对；阶段O推进到389/400。
...
- `python scripts/check_links.py`：2477个本地Markdown链接通过。
- 369个JSON卡，无重复ID，生成卡齐全。
- 总条目389、变体132；八套任务包48步、48个文本块、无双花括号变量。
