...
- 436条基础提示词：416张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T310–T313补剃须刀成组刀网、理发器限位梳、加湿器倒置底盖和断电台扇顺序拆装；阶段Q推进到436/440。
...
- `python scripts/check_links.py`：2712个本地Markdown链接通过。
- 416个JSON卡，无重复ID，生成卡齐全。
- 总条目436、变体132；八套任务包48步、48个文本块、无双花括号变量。
