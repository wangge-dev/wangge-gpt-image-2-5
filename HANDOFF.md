...
- 260条基础提示词：240张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T133–T137补刷杆刮口、旋转筛孔、胶囊泡罩、旅行分装托槽与喷雾锁夹。
...
- `python scripts/check_links.py`：1832个本地Markdown链接通过。
- 240个JSON卡，无重复ID，生成卡齐全。
- 总条目260、变体132；八套任务包48步、48个文本块、无双花括号变量。
