...
- 392条基础提示词：372张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T267–T269补F型夹两级调节、开罐器双轮夹位与翼式开瓶器同步翼臂；阶段O推进到392/400。
...
- `python scripts/check_links.py`：2492个本地Markdown链接通过。
- 372个JSON卡，无重复ID，生成卡齐全。
- 总条目392、变体132；八套任务包48步、48个文本块、无双花括号变量。
