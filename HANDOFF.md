...
- 160条基础提示词：140张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意，其中G52–G55补双面服饰、转换饰品、鞋带路径与肩带三档长度。
...
- 总条目160、变体132；八套任务包48步、48个文本块、无双花括号变量。
