...
- 516条基础提示词：496张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T390–T393补左右护理盒、存储卡嵌套、键盘底壳走线与护封文字随面；阶段U推进到516/520。
...
- `python scripts/check_links.py`：3112个本地Markdown链接通过。
- 496个JSON卡，无重复ID，生成卡齐全。
- 总条目516、变体132；八套任务包48步、48个文本块、无双花括号变量。
