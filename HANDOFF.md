...
- 286条基础提示词：266张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T161–T163补料箱卡套纸卡层级、托盘箱角柱逐角归属和网车层板同高挂点。
...
- `python scripts/check_links.py`：1962个本地Markdown链接通过。
- 266个JSON卡，无重复ID，生成卡齐全。
- 总条目286、变体132；八套任务包48步、48个文本块、无双花括号变量。
