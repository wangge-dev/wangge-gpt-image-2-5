...
- 230条基础提示词：210张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T105–T107补防拆环连接桥、瓦楞隔板互锁和线缆旗形标签双面方向。
...
- 总条目230、变体132；八套任务包48步、48个文本块、无双花括号变量。
