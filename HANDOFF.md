...
- 343条基础提示词：323张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T218–T220补纸窗跨材质、鞋面跨裁片与双层透明杯内层改字。
...
- `python scripts/check_links.py`：2247个本地Markdown链接通过。
- 323个JSON卡，无重复ID，生成卡齐全。
- 总条目343、变体132；八套任务包48步、48个文本块、无双花括号变量。
