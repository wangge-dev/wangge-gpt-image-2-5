...
- 315条基础提示词：295张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T190–T192补模压橡胶、刺绣贴布与反光热转印膜改字。
...
- `python scripts/check_links.py`：2107个本地Markdown链接通过。
- 295个JSON卡，无重复ID，生成卡齐全。
- 总条目315、变体132；八套任务包48步、48个文本块、无双花括号变量。
