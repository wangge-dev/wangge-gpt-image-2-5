...
- 426条基础提示词：406张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T301–T303补电热水壶外部组件、咖啡机手柄旋入和吸尘器地刷滚筒拆装；阶段Q推进到426/440。
...
- `python scripts/check_links.py`：2662个本地Markdown链接通过。
- 406个JSON卡，无重复ID，生成卡齐全。
- 总条目426、变体132；八套任务包48步、48个文本块、无双花括号变量。
