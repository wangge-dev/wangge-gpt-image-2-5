...
- 303条基础提示词：283张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T178–T180补双插管扶手、玻璃瓶丝印改字和软包装尾封喷码改字。
...
- `python scripts/check_links.py`：2047个本地Markdown链接通过。
- 283个JSON卡，无重复ID，生成卡齐全。
- 总条目303、变体132；八套任务包48步、48个文本块、无双花括号变量。
