...
- 320条基础提示词：300张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T193–T197补亚克力内雕、注塑凹字、植绒转印、金属凹槽填漆与全息转印箔改字。
...
- `python scripts/check_links.py`：2132个本地Markdown链接通过。
- 300个JSON卡，无重复ID，生成卡齐全。
- 总条目320、变体132；八套任务包48步、48个文本块、无双花括号变量。
