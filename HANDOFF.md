...
- 504条基础提示词：484张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T378–T381补柔性回穿、非镜像保护套、必经转接管与文字随卡移动；阶段U推进到504/520。
...
- `python scripts/check_links.py`：3052个本地Markdown链接通过。
- 484个JSON卡，无重复ID，生成卡齐全。
- 总条目504、变体132；八套任务包48步、48个文本块、无双花括号变量。
