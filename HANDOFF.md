...
- 204条基础提示词：184张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T78–T81补卷装标签、封箱胶带、可拆拖布和冷热敷袋层级。
...
- 总条目204、变体132；八套任务包48步、48个文本块、无双花括号变量。
