...
- 212条基础提示词：192张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T86–T89补打印耗材保护件、蜂窝纸缓冲角、清洁剂量杯和序列号逐字符核对。
...
- 总条目212、变体132；八套任务包48步、48个文本块、无双花括号变量。
