...
- 484条基础提示词：464张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T358–T361补鞋靴、腕表、户外与宠物用品的真实结构关系；阶段T推进到484/500。
...
- `python scripts/check_links.py`：2952个本地Markdown链接通过。
- 464个JSON卡，无重复ID，生成卡齐全。
- 总条目484、变体132；八套任务包48步、48个文本块、无双花括号变量。
