...
- 240条基础提示词：220张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T115–T117补裁纸刀刀路两侧归属、卷尺挂钩零点与档案袋双扣盘绕线。
...
- `python scripts/check_links.py`：1732个本地Markdown链接通过。
- 220个JSON卡，无重复ID，生成卡齐全。
- 总条目240、变体132；八套任务包48步、48个文本块、无双花括号变量。
