...
- 232条基础提示词：212张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T108–T109补线缆盘首尾端与绑带点、双轨密封袋逐段啮合。
...
- 总条目232、变体132；八套任务包48步、48个文本块、无双花括号变量。
