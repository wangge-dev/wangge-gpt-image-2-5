...
- 406条基础提示词：386张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T281–T283补左右鞋垫归位、成对耳钉拆装和背包胸扣双侧滑轨；阶段P推进到406/420。
...
- `python scripts/check_links.py`：2562个本地Markdown链接通过。
- 386个JSON卡，无重复ID，生成卡齐全。
- 总条目406、变体132；八套任务包48步、48个文本块、无双花括号变量。
