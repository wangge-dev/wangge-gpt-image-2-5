...
- 234条基础提示词：214张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T110–T111补盒盖密封圈四象限入槽与接头位置、日期章多字轮字符窗口与共同基准线核对。
...
- `python scripts/check_links.py`：1702个本地Markdown链接通过。
- 214个JSON卡，无重复ID，生成卡齐全。
- 总条目234、变体132；八套任务包48步、48个文本块、无双花括号变量。
