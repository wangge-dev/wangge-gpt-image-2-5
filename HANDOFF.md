...
- 180条基础提示词：160张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T55–T57补珠宝旋转、食品切面与纺织对花三类身份/拓扑核对。
...
- 总条目180、变体132；八套任务包48步、48个文本块、无双花括号变量。
