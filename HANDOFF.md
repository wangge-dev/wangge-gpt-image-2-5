...
- 312条基础提示词：292张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T187–T189补纸箱喷墨、陶瓷贴花和木材灼刻改字。
...
- `python scripts/check_links.py`：2092个本地Markdown链接通过。
- 292个JSON卡，无重复ID，生成卡齐全。
- 总条目312、变体132；八套任务包48步、48个文本块、无双花括号变量。
