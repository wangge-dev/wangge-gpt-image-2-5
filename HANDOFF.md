...
- 355条基础提示词：335张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T230–T232补轴端卡簧层序、柔性保护套窗口和双钩单扣侧盖状态。
...
- `python scripts/check_links.py`：2307个本地Markdown链接通过。
