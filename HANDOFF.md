...
- 184条基础提示词：164张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T58–T61补属性继承、软包装形变、刀模面位和货架价签遮挡。
...
- 总条目184、变体132；八套任务包48步、48个文本块、无双花括号变量。
