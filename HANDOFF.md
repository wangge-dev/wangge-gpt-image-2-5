...
- 274条基础提示词：254张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T149–T151补拉链滑块路径、礼盒提拉带绕底抬升和插舌纸盒盖片闭合层序。
...
- `python scripts/check_links.py`：1902个本地Markdown链接通过。
- 254个JSON卡，无重复ID，生成卡齐全。
- 总条目274、变体132；八套任务包48步、48个文本块、无双花括号变量。
