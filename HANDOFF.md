...
- 400条基础提示词：380张 `data/library.json` 卡、11条 `cases/`、9条 `experiments/`。
- 132个完整变体。
- 48套电商场景；EC01–EC48有填写完成的直接示例；另有55条精选创意；T274–T277补订书机驱动片、转盘打孔钳离散选档、压蒜器双铰接和手摇削笔器三参照系；阶段O达到400/400，后续进入阶段P 400→420。
...
- `python scripts/check_links.py`：2532个本地Markdown链接通过。
- 380个JSON卡，无重复ID，生成卡齐全。
- 总条目400、变体132；八套任务包48步、48个文本块、无双花括号变量。
