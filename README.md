...
**545 条基础提示词 · 132 个完整变体 · 电商、中文编辑与独特商业创意持续扩充。**

电商 EC01–EC58 均提供“拿来就用”的完整示例，同时保留可替换商品、文案和场景的变量模板；八个重点品类提供六步任务包。

包含 88 张适配卡、446 条原创提示词和11条来源明确的中文提示词；58 套电商场景提供86个变体。
...
| 查看已填好真实商品资料的执行包 | [System76 Launch 2 键盘四图](ecommerce/samples/system76-launch-2.md) |
...
[实拍换场景 → 人物持用 → 多语言营销素材](ecommerce/evolink-product-story.md)，附EvoLink原案例的输入与结果、中文示例及模板。
...
新收录：[G32 旅行票据纸雕](prompts/gallery/G32.md) · [G22 六格与六张独立广告](prompts/gallery/G22.md)。画廊支持案例直达、复制链接、图片放大与输入输出并排查看。

电商使用示例：EC01–EC25已补齐参考图准备与完整填写示例，打开卡片可在具体示例和变量模板之间选择。
