...
**112 条基础提示词 · 117 个完整变体 · 电商专区持续扩充。**

电商 EC01–EC35 均提供“拿来就用”的完整示例，同时保留可替换商品、文案和场景的变量模板；八个重点品类提供六步任务包。

包含 82 张适配卡、19 条原创提示词和11条来源明确的中文提示词；35 套电商场景提供86个变体。
...
| 想做什么 | 入口 |
| --- | --- |
| 商品主图、场景、详情、促销、品牌图 | [电商专区 · 35 套场景](ecommerce/README.md) |
